    ...
    <div className="space-y-6">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent className="rounded-3xl border-0 shadow-2xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-2xl font-black text-slate-800 flex items-center gap-2">
            ...
            <AlertDialogDescription className="text-slate-500 font-medium">
              ...
              <span className="text-slate-900 font-bold">{appointmentToDelete?.name}</span>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="gap-2">
            <AlertDialogCancel className="rounded-xl border-slate-200 text-slate-500 hover:bg-slate-50">Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={() => appointmentToDelete && deleteAppointment(appointmentToDelete)}
              className="rounded-xl bg-rose-500 hover:bg-rose-600 text-white border-0 shadow-lg shadow-rose-200"
              disabled={!!updating}
            >
              {updating ? <Loader2 size={16} className="animate-spin mr-2" /> : <Trash2 size={16} className="mr-2" />}
              Delete Appointment
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
