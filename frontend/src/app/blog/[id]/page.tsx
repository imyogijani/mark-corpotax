...
import { Calendar, User, ArrowRight, MessageSquare, Share2, Facebook, Twitter, Linkedin, Instagram, BarChart2, PieChart, DollarSign, TrendingUp } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'Blog Details',
  description: 'Read the full article and insights about financial planning and business strategies.',
};
...
const tags = [
  'Best Blogs', 'Consultation', 'Legal', 'Services', 'Strategy'
];
...
const comments = [
  {
    ...
    message: 'When first time I headed the direction and then how heart he turned a game. Within about have chance because.',
    ...
    <div className="blog-detail-page-container animate-fade-in">
      ...
      <section className="page-header-section py-16 md:py-24 bg-gradient-to-br from-[#2c3e50] to-[#34495e] text-white relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Blog Details</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="prose prose-lg max-w-none">
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      Aliquam erat elit, pretium vitae ligula nec, pellentesque aliquam dui. Proin venenatis purus pretium 
                      accumsan. Donec tincidunt fermentum gravida accumsan cursus interdum luctus eget dapibus lorem. Mauris 
                      luctus ligula sed elit rutrum rutrum. Donec at molestie mi, at rutrum mauris. Sed convallis ipsum quis 
                      mi rutrum.
                    </p>

                    <p className="text-muted-foreground leading-relaxed mb-8">
                      Aliquam erat elit, pretium vitae ligula nec, pellentesque aliquam dui. Proin venenatis purus pretium 
                      accumsan. Donec tincidunt fermentum gravida accumsan cursus interdum luctus eget dapibus lorem.
                    </p>

                    {/* Two Column Section */}
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                      <div>
                        <h3 className="text-xl font-bold mb-4 text-primary">Best Implementation</h3>
                        <p className="text-muted-foreground leading-relaxed">
                          Proin enim diam, blandit sit amet metus mollis, maxim pretium libero. Vivamus volutpat lorem 
                          lectus, eget dictum neque molestie eu. Praesent mollis ante eu magna in euismod.
                        </p>
                      </div>
                      <div>
                        <h3 className="text-xl font-bold mb-4 text-primary">Follow Your Concept</h3>
                        <p className="text-muted-foreground leading-relaxed">
                          Donec accumsan velit id odio congue porta. Vestibulum consequat dolor quis odio. Mauris 
                          eleifend lorem non mauris blandit, et rutrum libero molestie.
                        </p>
                      </div>
                    </div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      Aliquam erat elit, pretium vitae ligula nec, pellentesque aliquam dui. Proin venenatis purus pretium 
                      accumsan. Donec tincidunt fermentum gravida accumsan cursus interdum luctus eget dapibus lorem. Mauris 
                      luctus ligula sed elit rutrum rutrum. Donec at molestie mi, at rutrum mauris. Sed convallis ipsum quis mi rutrum.
                    </p>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 pt-8 border-t border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" className="text-xs">Best Blogs</Button>
                        <Button variant="outline" size="sm" className="text-xs">Consultation</Button>
                        <Button variant="outline" size="sm" className="text-xs">Legal</Button>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
              ...
              <Card className="bg-white mt-8">
                <CardHeader>
                  <CardTitle className="text-2xl font-bold">Comments ({comments.length + 1})</CardTitle>
                </CardHeader>
              ...
              <Card className="bg-white mt-8">
                <CardHeader>
                  <CardTitle className="text-2xl font-bold">Leave a comment</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <div className="space-y-8">
              ...
              <Card className="bg-white">
                <CardHeader>
                  <CardTitle className="text-xl font-bold">Recent Post</CardTitle>
                </CardHeader>
