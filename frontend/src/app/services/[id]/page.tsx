  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-32 pb-24 relative">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-[-10%] right-[-10%] w-[800px] h-[800px] bg-blue-100/30 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[900px] h-[900px] bg-emerald-50/40 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          <div className="w-12 h-12 rounded-full border border-slate-200 bg-white flex items-center justify-center group-hover:border-blue-600 group-hover:bg-blue-50 transition-all shadow-sm">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-32 items-center">
          <div className="space-y-10">
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <Link href="/appointment" className="w-full sm:w-auto block text-white no-underline">
                <button className={`w-full sm:w-auto px-10 py-6 text-white rounded-full font-black text-lg transition-all shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex items-center justify-center gap-4 group/btn ${isTaxation ? 'bg-emerald-600 shadow-emerald-200/50' : 'bg-blue-600 shadow-blue-200/50'}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          {/* Key Features Column */}
          <div className="bg-white rounded-[4rem] p-10 md:p-16 border border-slate-100 shadow-[0_30px_60px_rgba(0,0,0,0.02)] relative overflow-hidden h-full group">
          ...
          <div className="bg-slate-900 rounded-[4rem] p-10 md:p-16 text-white border border-slate-800 shadow-2xl relative overflow-hidden h-full group">
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-blue-600/10 rounded-full blur-[100px] -mr-40 -mb-40" />

            <div className="relative z-10">
              <div className="flex items-center gap-5 mb-12">
                <div className="w-14 h-14 bg-white/10 text-white rounded-full flex items-center justify-center border border-white/10 shadow-inner">
        ...
        <div className="mt-40">
          <div className="relative bg-white rounded-[4rem] p-10 md:p-24 border border-slate-100 text-center shadow-[0_50px_100px_rgba(0,0,0,0.03)] overflow-hidden group">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
               <div className="w-20 h-20 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-10 shadow-xl shadow-blue-200">
