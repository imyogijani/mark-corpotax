          ...
          <CardContent className="space-y-6">
            ...
            <section className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                prohibited from using the site to post or transmit any material
                that is threatening, defamatory, obscene, or that infringes on
            ...
            <section className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                purposes only and does not constitute financial advice. We
                provide the site on an &quot;as is&quot; and &quot;as
                available&quot; basis. We make no representations or warranties
                of any kind, express or implied, as to the operation of the site
                or the information, content, or materials included on the site.
              </p>
            </section>
            <section className="space-y-2">
              <h2 className="text-2xl font-semibold">
              ...
              <p className="text-muted-foreground">
                In no event shall FinWeb Dynamic be liable for any damages of
            ...
            <section className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                contact us at contact@finwebdynamic.com.
              </p>
            </section>
          </CardContent>
        </Card>
