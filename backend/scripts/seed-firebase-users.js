...
if (!fs.existsSync(serviceAccountPath)) {
  ...
  console.error('1. Go to https://console.firebase.google.com/project/meet-me-a78cc/settings/serviceaccounts/adminsdk');
  console.error('2. Click "Generate new private key"');
  console.error('3. Save the file as "serviceAccountKey.json" in backend/src/ folder');
  process.exit(1);
}
...
async function seedUsers() {
  try {
    ...
    const existingEmails = usersSnapshot.docs.map(doc => doc.data().email?.toLowerCase());
